        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown singleDrop ">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
              <li class=""><a href="shared-stories.html">Historias compartidas</a></li>
          ...
          <li class="dropdown singleDrop hide">
          ...
          <li class="dropdown singleDrop ">
            <a href="contact.html" ><i class="fa fa-phone" aria-hidden="true"></i> CONTACTO</a>
          </li>
          <li class="dropdown singleDrop profile-thumb-nav">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
              ...
              <li class=""><a href="profile.html">Perfil</a></li>
